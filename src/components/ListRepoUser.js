      ...
      <li>
        <div className="BoxInforStart">
          <div className="BoxNome">
            ...
            <p>{Infor}</p>
            <span className="boxBtnBlue">
              <label className={TagsActive}>
                <Tags tags={tags} />
              </label>
              <label for="BoxModalAddTags" className={BtnAdd}>
                <ButtonTags
                  content="Adicionar tags"
                  iconTags="/assets/addTags.svg"
                />
              </label>
              <label for="BoxModalEditTags" className={BtnEdit}>
                <ButtonTags
                  content="Editar tags"
                  iconTags="/assets/editTags.svg"
                />
              </label>
            </span>
          </div>
